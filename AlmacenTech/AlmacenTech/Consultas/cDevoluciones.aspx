<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="cDevoluciones.aspx.cs" Inherits="AlmacenTech.Consultas.cDevoluciones" %>
    ...
    <div class="row">
        ...
        <div class ="col-md-8 text-left">
                ...
                <asp:GridView ID="SalidasGridView" runat="server" CellPadding="4"  ForeColor="#333333" GridLines="None" Width="790px" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        <asp:BoundField DataField="DevolucionId" HeaderText="Devolucion ID   ">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="FechaDevolucion" HeaderText="Fecha" ReadOnly="True" SortExpression="FechaDevolucion">
                        <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
