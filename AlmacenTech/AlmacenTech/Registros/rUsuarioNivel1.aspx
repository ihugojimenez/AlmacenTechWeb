...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
            ...
            <div class ="col-md-12 text-center">
                <%--<asp:Button ID="SaveButton" runat="server" TabIndex="28"  CssClass="btn btn-info" Text="Registrar" Width="89px" ValidationGroup="Save"/>--%>
                <asp:LinkButton ID="SaveButton" runat="server" TabIndex="28" Width="480" CssClass="btn btn-info form-control"><span aria-hidden="true" class="glyphicon glyphicon-user"></span> Crear Usuario</asp:LinkButton>
