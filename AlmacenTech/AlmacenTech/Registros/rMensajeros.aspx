    ...
    <div class="jumbotron text-center ">
        ...
        <div class="row">
            ...
            <div class ="col-md-8 text-left">
                ...
                <br />
                <asp:TextBox ID="NombresTextBox" CssClass="form-control" runat="server" Width="480"></asp:TextBox>
            ...
            <div class ="col-md-8 text-left">
                ...
                <br />
                <asp:DropDownList ID="SexoDropDownList" CssClass="form-control" Width="480" runat="server">
            ...
            <div class ="col-md-8 text-left">
                ...
                <br />
                <asp:TextBox ID="CedulaTextBox" CssClass="form-control" runat="server" Width="480"></asp:TextBox>
            ...
            <div class ="col-md-8 text-left">
                ...
                <br />
                <asp:TextBox ID="CelularTextBox" CssClass="form-control" runat="server" Width="480"></asp:TextBox>
            ...
            <div class ="col-md-8 text-left">
                ...
                <br />
                <asp:TextBox ID="TelefonoTextBox" CssClass="form-control" runat="server" Width="480"></asp:TextBox>
            ...
            <div class ="col-md-8 text-left">
                ...
                <br />
                <asp:TextBox ID="DireccionTextBox"  CssClass="form-control" runat="server" Width="480" ></asp:TextBox>
